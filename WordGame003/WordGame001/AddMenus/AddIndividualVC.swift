...
class AddIndividualVC: UIViewController {
    ...
    @IBAction func Autofill(_ sender: UIButton) {
        ...
        ObjectInfoTxt.text = "you are in " + LocationField.text! + ", talking to " + ShortInfo.text!
        EntryPhrase.text = "start talking to " + ShortInfo.text!
        ConnectingMessage.text = "you start talking to " + ShortInfo.text!
        ExitPhrase.text = "stop talking to " + ShortInfo.text!
        ExitConnetionMessage.text = "you stop talking to " + ShortInfo.text!
    ...
    @IBAction func clearLocationField(_ sender: UIButton) {
    ...
    @IBAction func AutofillWithThe(_ sender: UIButton) {
        RoomID.text = ShortInfo.text! + "_index"
         ObjectInfoTxt.text = "you are in " + LocationField.text! + ", talking to the " + ShortInfo.text!
         EntryPhrase.text = "start talking to the " + ShortInfo.text!
         ConnectingMessage.text = "you start talking to the " + ShortInfo.text!
         ExitPhrase.text = "stop talking to the " + ShortInfo.text!
         ExitConnetionMessage.text = "you stop talking to the " + ShortInfo.text!
    }
    
 
    @IBAction func ProcessIndividual(_ sender: UIButton) {
...
"""
        ...
        if !((Ind.leftStr(1, MyString: ExitPhrase.text!) == "<" ||  ExitPhrase.text == ""))
        {
            ...
            W0300.Objects[Temp0001NewObjectIndex].ObjectConnections.append(W0100.ObjectConnectionStruct(ConnectedObjectIndex: -2, ID: ExitPhrase.text!, ConnectingMessage: ExitConnetionMessage.text! ))
