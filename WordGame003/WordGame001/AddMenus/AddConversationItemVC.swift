...
class AddConversationItemVC: UIViewController {
    ...
    @IBAction func Autofill(_ sender: UIButton) {
        ...
        EntryPhrase.text = "<what you say>"
        ConnectingMessage.text = "<what the response is>"
...
"""
        ...
        code1 = code1.replacingOccurrences(of: "ObjectID!", with: "\"" + ObjectID! + "\"")
               code1 = code1.replacingOccurrences(of: "RoomID.text!", with: "\"" + ItemID.text! + "\"")
         code1 = code1.replacingOccurrences(of: "RoomID.text", with: "\"" + ItemID.text! + "\"")
